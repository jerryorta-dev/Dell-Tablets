...
public class Gallery_Callout_Copy extends AbstractTextFieldParams implements  ITextFieldParams{
    public function Gallery_Callout_Copy() {
        super();
    }
    ...
    override public function noFont_VARS():void {
        ...
        // TEXT FORMAT
        _noFont_FORMAT_VARS.color(0x5f5f5f);
        _noFont_FORMAT_VARS.size(15);
    ...
    override public function embeddedFont_VARS():void {
        ...
        // TEXT FORMAT
        _embeddedFont_FORMAT_VARS.color(0x5f5f5f);
        _embeddedFont_FORMAT_VARS.size(15);
