...
public class ZoomIN_DefaultView extends AbstractButton implements IButton {
    ...
    public function ZoomIN_DefaultView( name:String, vars:Object = null, data:Object = null) {
//        super(aModel, aController);
    ...
    override public function draw():void {
        ...
        _offGraphic = new MovieClipFactory( new UIZoom().mcZoomInOff );
        this.addGraphic( _offGraphic );

        _onGraphic = new MovieClipFactory( new UIZoom().mcZoomInOn );
        this.addGraphic( _onGraphic );

        _overGraphic = new MovieClipFactory( new UIZoom().mcZoomInOn );
