...
public class NavPlayVARS extends AbstractTextFieldParams implements  ITextFieldParams{
    public function NavPlayVARS() {
        super();
    }
    ...
    override public function noFont_VARS():void {
        ...
        // TEXT FORMAT
        _noFont_FORMAT_VARS.color( 0x64b511 );
    ...
    override public function embeddedFont_VARS():void {
        ...
        // TEXT FORMAT
        _embeddedFont_FORMAT_VARS.color( 0x64b511 );
