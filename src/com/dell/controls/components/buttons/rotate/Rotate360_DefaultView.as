 ...
 */
package com.dell.controls.components.buttons.rotate {
...
public class Rotate360_DefaultView extends AbstractButton implements IButton {
    ...
    public function Rotate360_DefaultView( name:String, vars:Object = null, data:Object = null ) {
...
//        _offGraphic = createGraphic( new UI360().mc360IconOff );
//        _onGraphic = createGraphic( new UI360().mc360IconOn );
//        _overGraphic = createGraphic( new UI360().mc360IconOn );

        _offGraphic = new MovieClipFactory( new UI360().mc360IconOff );
        this.addGraphic( _offGraphic );

        _onGraphic = new MovieClipFactory( new UI360().mc360IconOn );
        this.addGraphic( _onGraphic );

        _overGraphic = new MovieClipFactory( new UI360().mc360IconOn );
