...
public class NavWorkVARS extends AbstractTextFieldParams implements  ITextFieldParams{
    public function NavWorkVARS() {
        super();
    }
    ...
    override public function noFont_VARS():void {
        ...
        // TEXT FORMAT
        _noFont_FORMAT_VARS.color( 0x197cbf );
        _noFont_FORMAT_VARS.size(20);
    ...
    override public function embeddedFont_VARS():void {
        ...
        // TEXT FORMAT
        _embeddedFont_FORMAT_VARS.color( 0x197cbf );
        _embeddedFont_FORMAT_VARS.size( 20 );
