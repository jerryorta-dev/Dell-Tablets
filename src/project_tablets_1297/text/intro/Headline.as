...
public class Headline extends AbstractTextFieldParams implements  ITextFieldParams{
    ...
    override public function noFont_VARS():void {
        ...
        _noFont_FORMAT_VARS.letterSpacing(-1);
...
//		_embeddedFont_FORMAT_VARS.font( "museoRegular" );
		...
		_embeddedFont_FORMAT_VARS.letterSpacing(-1);
    ...
    override public function textField_VARS():void {
        // TEXT FIELD
        _textField_VARS.width( 800 );
        _textField_VARS.height( 16 );
