...
public class CommonTextParams extends AbstractTextFieldParams implements  ITextFieldParams{
    public function CommonTextParams() {
        super();
    }
    ...
    override public function noFont_VARS():void {
        ...
        // TEXT FORMAT
        _noFont_FORMAT_VARS.color(0x990000);
    ...
    override public function embeddedFont_VARS():void {
        ...
        // TEXT FORMAT
        _embeddedFont_FORMAT_VARS.color(0xffffff);
