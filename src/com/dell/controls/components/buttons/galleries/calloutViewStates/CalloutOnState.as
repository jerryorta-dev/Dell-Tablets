...
public class CalloutOnState implements IButtonState {
    ...
    public function CalloutOnState( galleryNavButton:IButton, onGraphic:AbstractGraphic, offGraphic:AbstractGraphic, overGraphic:AbstractGraphic, callout:AbstractUI ) {
    ...
    public function off( event:MouseEvent = null ):void {
        ...
        TweenLite.to( this._onGraphic, this._buttonMain.transitionTime, { alpha: 0, ease:Sine.easeOut, overwrite:"all"});
