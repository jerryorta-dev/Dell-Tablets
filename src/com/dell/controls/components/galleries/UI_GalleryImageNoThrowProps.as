...
public class UI_GalleryImageNoThrowProps extends AbstractUI {
    ...
    public function UI_GalleryImageNoThrowProps(vars:Object = null, data:Object = null) {
        super(vars, data);
    ...
    override public function draw():void {
        ...
        this._leftNavButton = buttonFactory.add("leftNav", Button_C_Factory.GALLERY_NAV_OVER_IMAGE_LEFT, this, 205, 0, leftNavVars, this._data) as GalleryNavOverImageLeft;
        ...
        this._rightNavButton = buttonFactory.add("rightNav", Button_C_Factory.GALLERY_NAV_OVER_IMAGE_RIGHT, this, (Global.p.WIDTH - rightNavVars.width), 0, rightNavVars, this._data) as GalleryNavOverImageRight;
