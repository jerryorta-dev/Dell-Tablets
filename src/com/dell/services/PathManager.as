...
package com.dell.services
{
	...
	/**
	 * For testing, append the debug configuration url with ?c=us&cs=19&l=en&s=dhs 
	 * @author Jerry_Orta
	 * 
	 */	
	public class PathManager	
	{
        ...
        public static var configFilename:String = "config.xml";
        public static var loadersFolder:String = "loaders";
        public static var loadersSuffix:String = "_loaders.xml";
        ...
        public static var mp3Path:String;
        public static var dataPath:String;
        public static var binaryDataPath:String;
...
//			trace( "mainFile: " + mainFile );
			...
			PathManager.fontPath = ( _li.parameters.fontPath != null ) ? PathManager.baseURL + _li.parameters.fontPath : PathManager.baseURL + PathManager.assetFolder + "font/";
			PathManager.xmlPath = ( _li.parameters.xmlPath != null ) ? PathManager.baseURL + _li.parameters.xmlPath : PathManager.baseURL + "xml/";
			PathManager.cssPath = ( _li.parameters.cssPath != null ) ? PathManager.baseURL + _li.parameters.cssPath : PathManager.baseURL + PathManager.assetFolder + "css/";
			PathManager.imagePath = ( _li.parameters.imagePath != null ) ? PathManager.baseURL + _li.parameters.imagePath : PathManager.baseURL + PathManager.assetFolder + "image/";
			PathManager.videoPath = ( _li.parameters.videoPath != null ) ? PathManager.baseURL + _li.parameters.videoPath : PathManager.baseURL + PathManager.assetFolder + "video/";
			PathManager.swfPath = ( _li.parameters.swfPath != null ) ? PathManager.baseURL + _li.parameters.swfPath : PathManager.baseURL + PathManager.assetFolder + "swf/";
			PathManager.mp3Path = ( _li.parameters.mp3Path != null ) ? PathManager.baseURL + _li.parameters.mp3Path : PathManager.baseURL + PathManager.assetFolder + "mp3/";
			PathManager.dataPath = ( _li.parameters.dataPath != null ) ? PathManager.baseURL + _li.parameters.dataPath : PathManager.baseURL + PathManager.assetFolder + "data/";
			PathManager.binaryDataPath = ( _li.parameters.binaryDataPath != null ) ? PathManager.baseURL + _li.parameters.binaryDataPath : PathManager.baseURL + PathManager.assetFolder + "binaryData/";
        ...
        public static function getLocalizedLoadersXML():String {
            var language_country:String = PathManager.language + "_" + PathManager.country;
            var getBasePath:String = String(PathManager.xmlPath).replace("/xml/","/") + PathManager.assetFolder;
            return getBasePath  + "xml/" + PathManager.loadersFolder + "/" + language_country + PathManager.loadersSuffix;
        }

        public static function getConfigXML():String {
            var getBasePath:String = String(PathManager.xmlPath).replace("/xml/","/") + PathManager.assetFolder;
            return getBasePath  + "xml/" + PathManager.configFolder + "/" + PathManager.configFilename;
        }
