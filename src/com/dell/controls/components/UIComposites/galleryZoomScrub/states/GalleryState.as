...
public class GalleryState implements IGalleryScrubber{

    private var _ui:UI_SliderGalleryZoom;
    private var _name:String;


    public function GalleryState( ui:UI_SliderGalleryZoom ) {

        this._ui = ui;
        this._name = UI_SliderGalleryZoom.GALLERY_STATE;
    }
